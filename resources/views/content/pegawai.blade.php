...
@section('container')
                ...
                <div class="card mb-4">
                    <div class="card-body px-3 pt-4 pb-2">
                        <button type="button" class="btn bg-gradient-primary" data-bs-toggle="modal"
                            data-bs-target="#modalPegawai" id="addData">
                            Tambah Pegawai
                        </button>
                    </div>
                    <div class="card-body px-3 pt-4 pb-2">
    ...
    <div class="modal fade" id="modalPegawai" data-backdrop="static" tabindex="-1" role="dialog"
                        ...
                        <div class="form-group">
                            ...
                            <div class="fv-row mb-3 row">
                                ...
                                <fieldset id="jenis_kelamin" class="row ms-1 col-6">
                                    ...
                                    <div class="form-check col-4 form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" name="jenis_kelamin"
                                            id="jenis_kelamin_false" value="0" />
    ...
    <!--Modal edit Pegawai-->
    <div class="modal fade" id="modaleditPegawai" data-backdrop="static" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    <form id="formeditPegawai" name="formeditPegawai" class="form" action="#" autocomplete="off">
                        <div class="form-group">
                            ...
                            <div class="fv-row mb-3 row">
                                <label class="d-block fw-bold fs-6 mb-2 col-4 ">Jenis Kelamin</label>
                                <fieldset id="editjenis_kelamin" class="row ms-1 col-6">
                                    <div class="form-check col-4 form-check-custom form-check-solid">
                                    ...
                                    <div class="form-check col-4 form-check-custom form-check-solid">
                                        <input class="form-check-input" type="radio" name="editjenis_kelamin"
                                            id="editjenis_kelamin_false" value="0" />
